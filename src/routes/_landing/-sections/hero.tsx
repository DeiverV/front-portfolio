...
export const Hero = () => {
  ...
  return (
    ...
    >
      <section className="animate-[fadeIn_4s_ease-in] z-10 grid place-items-center">
      ...
      <figure className="flex absolute gap-8 justify-center flex-col h-[400px] aspect-square w-fit rounded-default p-4 bg-secondary/10 animate-[swing_1.5s_ease_infinite] ">
